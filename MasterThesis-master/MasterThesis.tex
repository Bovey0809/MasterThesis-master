...
Cross Ratio based & 4 IR LEDs, 1 camera & 0.3-0.4 deg without headmovement, 1-2 with head movement \cite{huang2014towards}& Head movement allowed \\ \midrule
...
\label{gaze_estimation_alforithms_categories}
\end{table}
